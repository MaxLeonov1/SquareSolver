...
square_solver: main.o input_output_functions.o solve_equation.o supporting_functions.o unit_test.o
	$(CXX) main.o input_output_functions.o solve_equation.o supporting_functions.o unit_test.o -o square_solver
